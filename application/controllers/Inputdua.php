...
class Inputdua extends CI_Controller 
{
	 ...
	 */
	public function input_dua()
	{
		$this->load->view('users/dashboard_sarpras2/input');
	}
	...
	{
        parent::__construct();
        $this->load->model('Sarpras_modeldua');
	}
	...
	public function save()
{
    ...
    $this->Sarpras_modeldua->insert_batch($data);
    redirect('pengunjung/labdua');
}
}
