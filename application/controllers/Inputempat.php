...
class Inputempat extends CI_Controller 
{
	 ...
	 */
	public function input_empat()
	{
		$this->load->view('users/dashboard_sarpras4/input');
	}
	...
	{
        parent::__construct();
        $this->load->model('Sarpras_modelempat');
	}
	...
	public function save()
{
    ...
    $this->Sarpras_modelempat->insert_batch($data);
    redirect('pengunjung/labempat');
}
}
